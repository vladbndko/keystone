...
- [#7051](https://github.com/keystonejs/keystone/pull/7051) [`52348d70d`](https://github.com/keystonejs/keystone/commit/52348d70df62ddc0b7e853deae0fb183974429c9) Thanks [@renovate](https://github.com/apps/renovate)! - Replaced `redis@3` with `@node-redis/client` (which is also re-exported from `redis@4`)
